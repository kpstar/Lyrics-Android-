...
import com.example.kpstar.lyricsapp.customize.videoreggae_adapter;
 ...
 */
public class ReggaeFragment extends Fragment implements videoreggae_adapter.RecyclerViewClickListener {


    WSDatabase database;
    List<video_item> videosItems;
    public SearchView searchView;
    videoreggae_adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        database.open();
        videosItems = database.getVideoItemsFromDatabase(1);
        adapter = new videoreggae_adapter(this.getActivity(), videosItems, this);
