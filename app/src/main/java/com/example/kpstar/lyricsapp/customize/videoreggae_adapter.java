...
public class videoreggae_adapter extends RecyclerView.Adapter<videoreggae_adapter.MyViewHolder> implements Filterable{
    ...
    public videoreggae_adapter(Context context, List<video_item> song_items) {
    ...
    public videoreggae_adapter(Context context, List<video_item> song_items, ReggaeFragment itemListener) {
