...
import com.example.kpstar.lyricsapp.customize.reggaephoto_adapter;
...
public class ReggaeFragment extends Fragment implements reggaephoto_adapter.RecyclerViewClickListener{


    WSDatabase database;
    ArrayList<photo_item> songItems;
    reggaephoto_adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        database.open();
        songItems = database.getPhotoItemsFromDatabase(1);
        adapter = new reggaephoto_adapter(this.getActivity(), songItems, this);
