...
public class songitem_adapter extends RecyclerView.Adapter<songitem_adapter.MyViewHolder> implements Filterable {
    ...
    public songitem_adapter(Context context, List<song_item> song_items, RockFragment itemListener) {
