 ...
 */
public class ReggaeFragment extends Fragment implements reggaeitem_adapter.RecyclerViewClickListener{


    WSDatabase database;
    ArrayList<song_item> songItems;
    public SearchView searchView;
    reggaeitem_adapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new reggaeitem_adapter(this.getActivity(), songItems, this);
