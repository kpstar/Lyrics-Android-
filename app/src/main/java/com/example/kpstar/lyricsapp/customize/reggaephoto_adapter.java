...
import com.example.kpstar.lyricsapp.photos.ReggaeFragment;
import com.example.kpstar.lyricsapp.photos.RockFragment;

import java.util.ArrayList;
import java.util.List;

public class reggaephoto_adapter extends RecyclerView.Adapter<reggaephoto_adapter.MyViewHolder> implements Filterable{
    ...
    public reggaephoto_adapter(Context context, List<photo_item> song_items) {
    ...
    public reggaephoto_adapter(Context context, List<photo_item> song_items, ReggaeFragment itemListener) {
